...
export const Base32 = class extends ReverseEngineer {
  //Configuration
  static name = "Base32"
  static description = "Encodes and decodes strings to/from Base32";
  static version = "1.1.1";
  static UI_POLICY = {
    requiresInit:false,
        directions:{
          init:{ input:false, args:false, inputPh:'—', argsPh:'—' },
          forward:{ input:true, args:true, inputPh:'Plain text to encode (RFC 4648 Base32)', argsPh:`[sanitize?, {"lower":true}]\nExamples:\n true\n [true, {"lower":true}]` },
          reverse:{ input:true, args:true, inputPh:'Base32 to decode (case-insensitive; padding optional)', argsPh:`[isSanitized?]\nExamples:\n true` }
        }
  }
  static category = "Encoders";
  static tags = ["Base32", "RFC4648", "Encoding", "Encode", "Decode", "Sanitize", "Lowercase"];
  constructor() {
    super();
    this.getInstance();
  }
